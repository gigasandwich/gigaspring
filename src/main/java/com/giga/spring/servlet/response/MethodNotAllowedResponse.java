...
public class MethodNotAllowedResponse extends GigaResponse {
    
    public MethodNotAllowedResponse(Route route, HttpServletRequest req, HttpServletResponse res, ServletContext context) throws Exception {
